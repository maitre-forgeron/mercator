...
public class LogisticsTests
{
    ...
    {
        var domainAssembly = Assembly.Load("Mercator.Logistics.Domain");

        var result = Types
            .InAssembly(domainAssembly)
            .ShouldNot()
            .HaveDependencyOnAny("Mercator.Logistics.Application", "Mercator.Logistics.Infrastructure")
            .GetResult();
    ...
    {
        var applicationAssembly = Assembly.Load("Mercator.Logistics.Application");

        var result = Types
            .InAssembly(applicationAssembly)
            .Should()
            .NotHaveDependencyOn("Mercator.Logistics.Infrastructure")
            .GetResult();
    ...
    {
        var infrastructureAssembly = Assembly.Load("Mercator.Logistics.Infrastructure");

        var result = Types
            .InAssembly(infrastructureAssembly)
            .Should()
            .NotHaveDependencyOn("Mercator.Logistics.Domain")
            .GetResult();
